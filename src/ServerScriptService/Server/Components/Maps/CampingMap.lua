...
local CampingMap = BaseComponent.CreateComponent("CampingMap", {
...
export type Impl = BaseComponent.ComponentImpl<MyImpl, Fields, "CampingMap", Instance, any...>
export type Component = BaseComponent.Component<MyImpl, Fields, "CampingMap", Instance, any...>
