...
local subscribe = TS.import(script, script.Parent.Parent, "include", "node_modules", "@rbxts", "charm", "src").subscribe
...
do
	...
	function StatusEffect:SetHumanoidData(Props, Priority)
		...
		self.HumanoidDataChanged:Fire(newData, self._internal_humanoidData)
