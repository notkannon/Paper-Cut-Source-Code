...
local ThrowableBookItem = BaseComponent.CreateComponent("ThrowableBookItem", {
	isAbstract = false,
}, BaseThrowable) :: BaseThrowable.Impl

--//Methods

function ThrowableBookItem.OnFlightStart(self, instance: BasePart, janitor: any, userData: { any })
