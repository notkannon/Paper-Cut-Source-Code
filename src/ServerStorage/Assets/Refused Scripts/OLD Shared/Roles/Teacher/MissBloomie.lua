...
local Animations = game.ReplicatedStorage.Assets.Animations.Teacher.MissBloomie

-- role data
return {
	enum = Enums.GameRolesEnum.MissBloomie,
	team = Teams.Teacher,
	
	name = 'Miss Bloomie',
	moveset_name = 'MissBloomie',
	descripton = '',
	...
	character = {
		morph = Server and Server.Instances.Morphs.MissBloomie,
		DefaultWalkspeed = 12.5,
